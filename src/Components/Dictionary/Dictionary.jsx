...
// import Animation from "../../assets/Animation/loadingDotsBlue.json"
...
function Dictionary() {
  ...
  console.log("this is data", data, isData);
  ...
  return (
    <div className="mt-20 px-3 ">
      ...
      {!isData && (
        <p className="text-slate-400 mt-2">Type a word to start searching</p>
      )}
